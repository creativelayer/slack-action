...
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(193);
...
try {
  ...
  const message = JSON.parse(_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput('message'))
  console.log(`Message: ${message}`)

  const update = !!message.ts

  const { data, status } = await axios__WEBPACK_IMPORTED_MODULE_1__/* ["default"].post */ .Z.post(
  ...
  if (status == 200) {
    ...
    _actions_core__WEBPACK_IMPORTED_MODULE_0__.setOutput("timestamp", timestamp)
  }
